...
<div class="container" style="width:65%">
   ...
   <div style="display:inline-block; float:right;">
      <button type="button" class="btn btn-outline-danger btn-sm" style="margin-right:10px;">신고</button>
   </div>
   <br>
   <hr>
...
<a href="#this" id="commentWrite"><input type="button" value="수정하기" class="btn btn-outline-dark" style="width:100%; height:59px;"></a> 
...
<hr>
	<div style="float:right;">
      ...
      <a href="#this" class="btn" id="modify"><button type="button" class="btn btn-outline-dark" style="margin-right:6px;">수정</button></a>
      <a href="#this" class="btn" id="delete"><button type="button" class="btn btn-outline-dark" style="margin-right:6px;">삭제</button></a>
      </c:if>
      <button type="button" class="btn btn-outline-dark" onclick="location.href='http://localhost:8007/solo/board/openBoardList.do'" style="margin-right:6px;">목록</button>
      <button type="button" class="btn btn-outline-dark" onclick="location.href='http://localhost:8007/solo/board/openBoardWrite.do'">글쓰기</button>
  	 </div>
