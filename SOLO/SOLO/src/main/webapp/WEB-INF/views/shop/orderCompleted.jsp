...
<div class="container" style="width:45%;">
	...
	<div>
		<table style="width:100%;" class="table">
			...
			<tr>
				...
				<td>${map.ORDER_DADD1}</td>
			</tr>
			<tr>
				<th width="30%" style="padding-left:20px;">상세주소</th>
				<td>${map.ORDER_DADD2}</td>
			</tr>
			<tr>
	...
	<hr>
	<div align="center">
		<input type="button" class="btn btn-dark" value="홈으로" onClick="location.href='/solo/main/openMainList.do'">
	</div>
</div>
