...
<div class="container" id="frm" style="width:60%;">
   ...
   <!-- 버튼 -->
   <div align="center">
        <a href="#this" id="modify"><input type="button" class="btn btn-outline-secondary" value="공지 수정"></a>
...
function fn_updateBoard(){
   ...
   var comSubmit = new ComSubmit("frm");
      comSubmit.setUrl("<c:url value='/admin/updateAcs.do' />");
      if (!$("#NOTICE_TYPE").val() || $("#NOTICE_TYPE").val() == '글 유형') {
         alert("카테고리를 선택하세요.");
         $("#NOTICE_TYPE").focus();
         return false;
      }
