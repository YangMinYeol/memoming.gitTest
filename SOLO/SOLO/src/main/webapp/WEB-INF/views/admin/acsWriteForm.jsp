...
<div class="container" id="frm" style="width:60%;">
   ...
   <!-- 내용 -->
   <div style="margin-bottom:15px;"><textarea class="form-control" id="NOTICE_CONTENT" name="NOTICE_CONTENT" placeholder="내용을 입력해주세요." rows="12"></textarea></div>
   
   <!-- 버튼 -->
   <div align="center">
        <a href="#this" id="write"><input type="button" class="btn btn-outline-dark" value="공지 등록"></a>
		<input type="button" class="btn btn-outline-dark" value="취 소" onclick="location.href='http://localhost:8007/solo/admin/acsBoardList.do'">
   </div>
</div>
