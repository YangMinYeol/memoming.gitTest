...
<ul class="nav nav-tabs">
     <li class="active">
       <a class="nav-link" href="<c:url value='/admin/order_admin_a.do'/>"><font color=black>주문관리</font></a>
     </li>
     <li class="nav-item">
       <a class="nav-link active" href="<c:url value='/admin/as_admin.do?as=4'/>"><font color=black><b>교환/반품/취소</b></font></a>
     </li>
</ul>
		...
		<nav>
			...
			<c:choose>
				<c:when test="${fn:length(as_admin_list) > 0}">
                  ...
                  |&nbsp;<li class="active"><a href="/solo/admin/as_admin.do?as=4" style="text-decoration:none; color:black;"><strong><font color=black>취소접수</font></strong></a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  |&nbsp;<li><a href="/solo/admin/as_admin.do?as=4"><font color=gray>취소접수</font></a> | </li>&nbsp;
                  </c:otherwise>
               </c:choose>
               <c:choose>
                  <c:when test="${state.AORDER_STATE eq '5' }">
                  <li class="active"><a href="/solo/admin/as_admin.do?as=5" style="text-decoration:none; color:black;"><strong><font color=black>취소완료</font></strong></a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  <li><a href="/solo/admin/as_admin.do?as=5"><font color=gray>취소완료</font></a> | </li>&nbsp;
                  </c:otherwise>
               </c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '6' }">
						<li class="active"><a href="/solo/admin/as_admin.do?as=6" style="text-decoration:none; color:black;"><strong><font color=black>교환접수</font></strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/solo/admin/as_admin.do?as=6"><font color=gray>교환접수</font></a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '7' }">
						<li class="active"><a href="/solo/admin/as_admin.do?as=7" style="text-decoration:none; color:black;"><strong><font color=black>교환중</font></strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/solo/admin/as_admin.do?as=7"><font color=gray>교환중</font></a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '8' }">
						<li class="active"><a href="/solo/admin/as_admin.do?as=8" style="text-decoration:none; color:black;"><strong><font color=black>교환완료</font></strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/solo/admin/as_admin.do?as=8"><font color=gray>교환완료</font></a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '9' }">
						<li class="active"><a href="/solo/admin/as_admin.do?as=9" style="text-decoration:none; color:black;"><strong><font color=black>반품접수</font></strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/solo/admin/as_admin.do?as=9"><font color=gray>반품접수</font></a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '10' }">
						<li class="active"><a href="/solo/admin/as_admin.do?as=10" style="text-decoration:none; color:black;"><strong><font color=black>반품완료</font></strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/solo/admin/as_admin.do?as=10"><font color=gray>반품완료</font></a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					</c:forEach>
				</c:when>
