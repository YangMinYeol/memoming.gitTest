...
function order_list() {
	...
	location.href="/solo/admin/order_admin_a.do?os="+os;
	return;	
}
...
<div class="container" style="width:50%;">
	...
	<div style="float:right; margin-right:20px;">
			<input type="button" class="btn btn-outline-dark btn-sm" onclick="order_list(); return false;" value="목록으로">
	</div>
</div>
