...
<form id="frm">
<table class="joinFormView table" style="border:0;cellpadding:1; cellspacing:1; width:100%;" align="center">
   
	<tr>
		<th style="width:30%;">신고 번호</th>
      
		<td align="center" style="width:*;">${map.REPORT_NUM}</td>   
	</tr>
	...
	<tr>
		...
		<td align="center" colspan="4">${map.MEM_ID}</td>   
	</tr>
   
	<tr>
		<th>닉네임</th>
      
		<td align="center" colspan="4">${map.MEM_NICK}</td>   
	</tr>
	...
	<tr>
		...
		<td align="center" colspan="4">${map.REPORT_COMMENT}</td>   
	</tr>
...
<hr>
<div align="center">
	<a href="#this" name="ok"><input type="button" class="btn btn-dark" value="확인"></a>
	<input type="button" class="btn btn-outline-dark" value="취소" onclick="location.href='http://localhost:8007/solo/report/openAdminReport.do'">
</div>
