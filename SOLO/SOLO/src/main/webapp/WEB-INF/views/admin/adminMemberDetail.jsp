...
<div class="container" style="width:50%;">
	<table class="table table-striped" style="border:0;cellpadding:1; cellspacing:1; width:100%;" align="center">
		<tr>
   ...
   <div style="float:right;">
		<a href="#this" name="ignore"><input type="button" class="btn btn-outline-secondary" value="저장">
