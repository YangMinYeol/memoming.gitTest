...
<body onload="fn_allPrice()">
	...
	<div class="container" style="width: 70%;">
		...
		<div style="text-align: right">
			...
			<input type="button" name="all_basket_delete" class="btn btn-outline-dark btn-sm" value="모두삭제" style="margin-right:15px;" onclick="fn_allDelete()">
		</div>
	...
	<c:choose>
		<c:when test="${fn:length(list) > 0}">
			...
			<div style="text-align: right">
				<input type="button" class="btn btn-primary" name="all_order" value="전체주문" onclick="fn_all_order()"> 
				<input type="button" class="btn btn-outline-primary" name="select_order" value="선택상품주문" onclick="fn_select_order()">
			</div>
		</c:when>
	</c:choose>
</div>
