...
<div class="container">
	<table align="center" class="table table-hover" style="cellpadding:7px;">
      	...
      	<tbody>
            ...
            <c:forEach items="${list}" var="row">
				<tr>
        	        ...
        	        <td class="title"><a href="#this" name="title">${row.BOARD_TITLE} [${row.TOTAL_COMMENTS}]</a>
      ...
      <div>
         <input type="button" class="btn btn-outline-dark" value="My Page" style="float:right; margin-right:20px;"
         onclick="location.href='/solo/member/openMyInfoForm.do'">
      </div>
</div>
