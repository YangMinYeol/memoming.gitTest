package solo.admin.aorder.controller;
...
import solo.admin.aorder.service.AdminOrdersService;
...
public class AdminOrdersController {
    ...
    public ModelAndView as_admin_list(CommandMap commandMap, HttpServletRequest request) throws Exception {
    	...
    	if(request.getParameter("as") != null && request.getParameter("as") != ""){ // 만약 as값이 널이아니고 공백이아니면
    		AORDER_STATE = request.getParameter("as"); // as값을 AORDER_STATE에 넣어준다
    	}
