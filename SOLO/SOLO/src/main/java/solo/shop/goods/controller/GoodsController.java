...
public class GoodsController {
	...
	public ModelAndView newGoodsList(CommandMap commandMap) throws Exception {
		...
		mv.addObject("TITLEMAIN", "신상품");
		
		return mv;
	}
	
	// 인기상품 리스트
	@RequestMapping(value = "/shop/bestGoodsList.do")
	public ModelAndView bestGoodsList(CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("jsonView");
	...
	public ModelAndView openGoodsList(@PathVariable String cate, @PathVariable String orderBy, CommandMap commandMap,
		...
		ModelAndView mv = new ModelAndView("/shop/cateGoodsList"); //("/shop/homeTrGoodsList");
	...
	public ModelAndView selectGoodsList(@PathVariable String cate, @PathVariable String orderBy, CommandMap commandMap,
		...
		System.out.println("카테고리 정렬=" + orderBy);
	...
	// 상품 등록폼
	@RequestMapping(value = "/shop/openGoodsWrite.do")
	...
	public ModelAndView goodsWrite(CommandMap commandMap, HttpServletRequest request) throws Exception{
		...
		System.out.println("상품등록" + commandMap.getMap());
		return mv;
	}
	...
	public ModelAndView goodsDetail(CommandMap commandMap, HttpServletRequest request) throws Exception{
		...
		mv.addObject("Color", arrColor); // 컬로 총 갯수
	...
	public ModelAndView insertBasket(CommandMap commandMap, HttpServletRequest request) throws Exception { // 상품디테일에서 장바구니 추가 
		...
		HttpSession session = request.getSession(); // 세션 값으로 적용
