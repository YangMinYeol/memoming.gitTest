...
function search_check(num) {
	if (num == '1') { // num이 1이면 아이디 찾기
		document.getElementById("searchP").style.display = "none";
		document.getElementById("searchI").style.display = "";	
	} else { // num이 2이면 비밀번호 찾기
...
$(document).ready(function() {
	...
	$("#searchBtn").click(function(){ // 버튼을 클릭하면
...
var idSearch_click = function(){
	var name = $("#MEM_NAME").val(); // name에 MEM_NAME값을 넣음
	$.ajax({
		type:"POST",
...
var pwSearch_click = function(){
	...
	$.ajax({
		...
		success : function(data){
			...
			window.location = "http://localhost:8007/solo/member/openLoginForm.do";
			}else{
...
<div class="container" style="width:30%;">
	...
	<div id="searchI">
		...
		<div class="form-group">
			<button id="searchBtn" type="button" onclick="idSearch_click()" class="btn btn-outline-dark" style="width:49%; float:left;">확인</button>
			<a class="btn btn-outline-dark"	href="${pageContext.request.contextPath}/member/openLoginForm.do" style="width:49%; float:right;">취소</a>
		</div>
	...
	<div id="searchP" style="display: none;">
		...
		<div class="form-group">
		<button id="searchBtn2" type="button" onclick="pwSearch_click()" class="btn btn-outline-dark" style="width:49%; float:left;">확인</button>
		<a class="btn btn-outline-dark"	href="${pageContext.request.contextPath}/member/openLoginForm.do" style="width:49%; float:right;">취소</a>
